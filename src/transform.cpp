...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("./res/vsfs/5.1.transform.vs", "./res/vsfs/5.1.transform.fs");
    ...
    if (data)
    {
        // note that the awesomeface.png has transparency and thus alpha channel, so make sure to tell OpenGL the data type is of GL_RGBA
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 transform = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix
        ...
        //now with the uniform matrix being replaced with new transformation, draw it again
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
