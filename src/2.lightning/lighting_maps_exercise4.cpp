...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("./res/vsfs/2.lighting/4.2.lighting_maps.vs","./res/vsfs/2.lighting/4.2.lighting_maps_exercise4.fs");
    ...
    img_path = "./res/img/lighting_maps_specular_color.png";
    unsigned int specularMap = loadTexture(img_path.c_str());
    img_path = "./res/img/matrix.jpg";
    unsigned int emissionMap = loadTexture(img_path.c_str());
