...
int main()
{
    ...
    // -------------------------
    Shader shader("./res/vsfs/5.advanced_lighting/5.3.parallax_mapping.vs", "./res/vsfs/5.advanced_lighting/5.3.parallax_mapping.fs");

    // load textures
    // -------------
    std::string texture_path = "./res/img/bricks2.jpg";
    unsigned int diffuseMap = loadTexture(texture_path.c_str());
    texture_path = "./res/img/bricks2_normal.jpg";
    unsigned int normalMap = loadTexture(texture_path.c_str());
    texture_path = "./res/img/bricks2_disp.jpg";
    unsigned int heightMap = loadTexture(texture_path.c_str());
