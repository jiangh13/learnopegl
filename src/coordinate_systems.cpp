...
int main()
{
    ...
    // -------------------------------------
    Shader ourShader("./res/vsfs/6.1.coordinate_systems.vs", "./res/vsfs/6.1.coordinate_systems.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
      ...
      // -----
        ...
        // note: currently we set the projection matrix each frame, but since the projection matrix rarely changes it's often best practis
    ...
    // glfw: terminate, clearing all previously allowcated GLFW resources.
    // ------------------------------------------------------------------
    glfwTerminate();
    return 0;
}
